<!--
English reference for ko-qmd, carried over from the tobi/qmd README (MIT) with the
ko-qmd sections (marked "(ko-qmd)") and install/import names switched to `ko-qmd`.
The Korean overview, install, and operations guide is the top-level README.md.
-->

# ko-qmd Reference (QMD - Query Markup Documents)
...
npm install -g ko-qmd
# or
bun install -g ko-qmd
